...
ActiveRecord::Schema[7.0].define(version: 2022_11_03_092855) do
  ...
  create_table "segments", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "shelves", id: :integer, charset: "utf8mb3", force: :cascade do |t|
